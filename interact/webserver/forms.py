...
from webserver.models import Register_user
...
class RegisterForm(forms.Form):
    ...
    def clean_adm_no(self):
        ...
        # ------------ BUG : roll number validation not working ------#
        # elif((rno[1]!='i' and rno[0]!='u') or (rno[1]!='I' and rno[0]!='U')):
        #     print("here")
...
class LoginForm(forms.Form):
    ...
    def clean_password(self):
        ...
        # TODO : Add password verification from database 
